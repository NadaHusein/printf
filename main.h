 ...
 *
 * @unsign_flag: if unsigned value
 *
 * @plus_flag: if plus_flag specified
 * @space_flag: if _flag specified
 * @hashtag_flag: if hashtag specified
 ...
 *
 * @h_modofier: if h_modifier is specified
...
char *get_precision(char *p, params_t *params, vaa_list ap);
